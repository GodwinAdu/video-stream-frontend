        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center p-4">
            <Card className="w-full max-w-md bg-gray-900/80 backdrop-blur-xl border-gray-700/50 rounded-2xl shadow-2xl">
                <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-gray-50 text-2xl font-bold">Media Permissions</CardTitle>
                ...
                <CardContent className="space-y-6">
                    <div className="space-y-4">
                        <div className="flex items-center space-x-3 p-3 bg-gray-800/30 rounded-xl">
                            ...
                            <div>
                                <p className="text-gray-200 font-medium">Camera Access</p>
                                <p className="text-gray-400 text-sm">Share your video with other participants</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-3 p-3 bg-gray-800/30 rounded-xl">
                            <Mic className="w-5 h-5 text-green-400" />
                            <div>
                                <p className="text-gray-200 font-medium">Microphone Access</p>
                                <p className="text-gray-400 text-sm">Communicate with other participants</p>
                            </div>
                        </div>
                    </div>
